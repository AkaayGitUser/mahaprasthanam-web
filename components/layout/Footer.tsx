        ...
        <div className="max-w-[1100px] mx-auto  px-6 mt-5">
          <div className=" relative -top-13 bg-[#0E2B3E] shadow-xl">
            <div className="grid grid-cols-1 md:grid-cols-3">
              ...
              <div
                ...
                className="flex items-center gap-6 px-10 py-8 cursor-pointer hover:bg-[#123C56]/40 transition-colors"
              >
                <Image
          ...
          <div className="grid lg:grid-cols-4 gap-20 ">
            ...
            <div>
              ...
              <div
                onClick={() => handleLocationClick("jubilee")}
                className={`cursor-pointer group p-2 -ml-2 rounded-lg transition-all duration-200 ${activeLocationId === "jubilee" ? "bg-[#123C56] ring-1 ring-[#F78B1F]" : "hover:bg-[#123C56]/50"
                  }`}
              >
                <h3 className="text-[#F78B1F] text-sm font-medium mb-3 font-plus-jakarta group-hover:underline">
                  Jubilee Hills
                </h3>
            ...
            <div className="lg:pt-12">
              <div
                ...
                className={`cursor-pointer group p-2 -ml-2 rounded-lg transition-all duration-200 ${activeLocationId === "punjagutta" ? "bg-[#123C56] ring-1 ring-[#F78B1F]" : "hover:bg-[#123C56]/50"
                  }`}
              >
                <h3 className="text-[#F78B1F] text-sm font-medium mb-3 font-plus-jakarta group-hover:underline">
                  Punjagutta
            ...
            <div className="lg:pt-12">
              <div
                ...
                className={`cursor-pointer group p-2 -ml-2 rounded-lg transition-all duration-200 ${activeLocationId === "begumpet" ? "bg-[#123C56] ring-1 ring-[#F78B1F]" : "hover:bg-[#123C56]/50"
                  }`}
              >
                <h3 className="text-[#F78B1F] text-sm font-medium mb-3 font-plus-jakarta group-hover:underline">
                  Begumpet
