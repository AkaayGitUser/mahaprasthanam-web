  ...
  return (
    <div>
      ...
      >
        ...
        {/* Content */}
        <div className=" font-jakarta relative z-10 flex flex-col items-center justify-center h-120 text-center px-6">
          <h1 className=" font-jakarta text-5xl md:text-5xl font-semibold text-white max-w-6xl">
            A Sanctuary of Peace. A Legacy of Dignity.
          </h1>

          <p className="text-white text-md mt-8 max-w-4xl">
